...
#ROC Curve for SVM
print("Displaying ROC Curve for SVM...")
RocCurveDisplay.from_estimator(clf, X_testr, y_testr)
plt.title("SVM ROC Curve")
plt.show()

#ROC curve for Random-Forest
print("Displaying ROC Curve for Random Forest...")
RocCurveDisplay.from_estimator(clf1, X_testr, y_testr)
